...
threshold = 10000000004
threshold_infinity = 1000
...
def main():
    ...
    print 'Clusters sets diciontary: ', clusters
...
def allNpsCompatible (cluster_i, cluster_j):
    for m_x in cluster_i:
        for m_y in cluster_j:
            if (distance(markables_dict[m_x],markables_dict[m_y]) > threshold_infinity):
                return False
    return True
